...
~~~
GET		     /users/{id} //Requests user profile data
GET		     /users/{id}/city //Requests specific user data; this example, the user's city
GET		     /users/{id}/photos //Requests all photos owned by the user
GET		     /users/{id}/photoalbums/{albumid}/photos //Requests all photos owned by the user in a specific album
PUT		     /users/{id}/phones/work=555-555-1111 //Updates user work phone
DELETE		     /users/{id} //Deletes user account
POST		     /users/password=12345&email=something@this.com //Creates new user account
POST		     /users/{id}/photo //Adds a new photo to the user's account
POST		     /users/{id}/device //Adds a new device to the user's account
